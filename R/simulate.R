...
#' @examples
#' library(subset)
#' sim.data<-simulate.mvdata(500,200,2,c(100,200,300),6,c(0.04,0.06,0.08))
#' 
#' @export
simulate.mvdata<-function(n=100,p=10,mu=1,locations=40,durations=20,proportions=0.1)
{
    if(length(n) > 1)
    {
